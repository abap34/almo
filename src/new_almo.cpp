...
int main(int argc, char* argv[]) {
    ...
    // パース
    auto [meta_data, ast] = almo::feature::parse_md_file(argv[1]);
    ...
    almo::feature::meta_data = meta_data;

    std::string result = almo::feature::render(ast, meta_data);
